...
export const WEDDING = {
  ...
  pix: {
    key: "lucasevanessa@casamento.com",
    name: "Lucas & Vanessa",
  },
  timeline: [
    { year: "2018", title: "Onde tudo começou", text: "Um olhar despretensioso numa noite de inverno mudou tudo." },
    { year: "2020", title: "Primeira viagem", text: "Lisboa nos ensinou que casa é a pessoa, não o lugar." },
    { year: "2022", title: "Nossa primeira casa", text: "Um apartamento pequeno, um amor enorme." },
    { year: "2024", title: "O pedido", text: "Ele se ajoelhou. Ela chorou. Ambos disseram sim." },
    { year: "2026", title: "O grande dia", text: "Agora celebramos com você, ao nosso lado." },
  ],
  gifts: [
